    ...
    def __init__(self):
        ...
        record_values = {
                         'data1': {
                                   ...
                                   'row_bit_size': 8,
                                   'coloms': {
                                       'ECO': {'bit': 1, 'col_type': 'button', 'options': None,
                                               'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                       'EPB': {'bit': 1, 'col_type': 'button', 'options': None,
                                               'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                       'AHLS': {'bit': 1, 'col_type': 'button', 'options': None,
                                                'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                       'MDPS': {'bit': 1, 'col_type': 'button', 'options': None,
                                                'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                       'ESC': {'bit': 1, 'col_type': 'button', 'options': None,
                                               'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                       'TPMS': {'bit': 1, 'col_type': 'button', 'options': None,
                                                'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                       'NORMAL': {'bit': 1, 'col_type': 'button', 'options': None,
                                                  'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                       'ECS': {'bit': 1, 'col_type': 'button', 'options': None,
                                               'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None}}},
                          'data2': {
                              'row_type': 'bitwise',
                              'row_bit_size': 8,
                              'coloms': {
                                  'ABS': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'AIRBAG': {'bit': 1, 'col_type': 'button', 'options': None,
                                             'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'PSB': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'AFL': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  '4WD': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'AT': {'bit': 1, 'col_type': 'button', 'options': None,
                                         'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'SPORT': {'bit': 1, 'col_type': 'button', 'options': None,
                                            'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'eCall': {'bit': 1, 'col_type': 'button', 'options': None,
                                            'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None}}},
                        'data3': {
                              'row_type': 'bitwise',
                              'row_bit_size': 8,
                              'coloms': {
                                  'FuelType': {'bit': 2, 'col_type': 'combobox', 'options': {'GSL':0b00,'DSL':0b01,'LPI':0b10,'OTHERS':0b11},
                                               'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'Speedometer Type': {'bit': 2, 'col_type': 'combobox', 'options': {'KPH':0b00,'KMPH':0b01,'MKPH':0b10},
                                                       'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'PSB': {'bit': 4, 'col_type': 'combobox', 'options': {'DOM': 0b0000, 'GEN': 0b0001, 'MID': 0b0010, 'EEC': 0b0011, 'AUS': 0b0100, 'CAN': 0b0101, 'USA': 0b0110, 'CHINA': 0b0111, 
                        ...
                        'data4': {
                              ...
                              'coloms': {
                                  ...
                                  'Power Type': {'bit': 3, 'col_type': 'combobox', 'options':{'ICV': 0b000, 'HEV': 0b001, 'PHEV': 0b010, 'EV': 0b011, 'FCEV': 0b100},
                                                 'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'High Performance Type': {'bit': 2, 'col_type': 'combobox', 'options': {'OFF': 0b00, 'HIGH_PERFORMANCE': 0b01, 'N': 0b10},
                                                            'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                        ...
                        'data5': {
                              ...
                              'coloms': {
                                  ...
                                  'Maximum Indicated Speed': {'bit': 3, 'col_type': 'combobox', 'options': {'KPH_260': 0b000, 'KPH_160': 0b001, 'KPH_220': 0b010, 'KPH_300': 0b011},
                                                 'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'HUD': {'bit': 1, 'col_type': 'button', 'options':None, 'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'Fuel Tank Size': {'bit': 2, 'col_type': 'combobox', 'options': {'TANK_A': 0b00, 'TANK_B': 0b01, 'TANK_C': 0b10, 'TANK_D': 0b11},
                                                     'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                        ...
                        'data6': {
                              ...
                              'row_bit_size': 8,
                              'coloms': {
                                  'RSBR': {'bit': 3, 'col_type': 'combobox', 'options': {'NONE': 0b000, 'R2_P2': 0b001, 'R2_P3': 0b010, 'R2_P2_R3_P2': 0b011, 'R2_P3_R3_P2': 0b100,'R2_P2_R3_P3': 0b101, 'R2_P3_R3_P3': 0b110},
                                           'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'Body Type': {'bit': 3, 'col_type': 'combobox', 'options': {'SEDAN': 0b000, 'SUV': 0b001, 'MPV': 0b010, 'WAGON': 0b011, 'HATCHBACK': 0b100, 'PICKUP_TRUCK': 0b101, 'TYPE_G': 0b110, 'TYPE_H': 0b111},
                                                 'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                        ...
                        'data7': {
                              ...
                              'row_bit_size': 8,
                              'coloms': {
                                  'FCA': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'FCA2': {'bit': 1, 'col_type': 'button', 'options': None,
                                             'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'LKA': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'ISLA': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'DAW': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'SCC': {'bit': 1, 'col_type': 'button', 'options': None,
                                         'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'LFA': {'bit': 1, 'col_type': 'button', 'options': None,
                                            'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'HDA': {'bit': 1, 'col_type': 'button', 'options': None,
                                            'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None}}},
                        'data8': {
                              'row_type': 'bitwise',
                              'row_bit_size': 8,
                              'coloms': {
                                  'HDA2': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'HDP': {'bit': 1, 'col_type': 'button', 'options': None,
                                             'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'Emergency Stop': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'PDW': {'bit': 1, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'reserved': {'bit': 4, 'col_type': 'button', 'options': None,
                                          'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'SCC': {'bit': 1, 'col_type': 'button', 'options': None,
                                         'r_type': 'bool', 'w_type': 'bool', 'r_val': None, 'w_val': None},
                                  'LFA': {'bit': 1, 'col_type': 'button', 'options': None,
