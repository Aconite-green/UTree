...
class CanManager:
    ...
    # Connect CAN BUS
                ...
                self.error_handler.handle_error(f"Failed to initialize CAN bus: {str(e)}")
            ...
            self.layer = isotp.TransportLayer(rxfn=self._rxfn, txfn=self._txfn,address=addr, error_handler=self.error_handler, params=params)
            self.layer.start()
